...
from metaworld.envs.mujoco.sawyer_xyz.v2 import (
    ...
    SawyerCoffeeButtonEnvV2, SawyerDoorCloseEnvV2, SawyerDoorEnvV2,
    SawyerDoorLockEnvV2, SawyerDoorUnlockEnvV2, SawyerHammerEnvV2,
    SawyerHandlePullEnvV2, SawyerNutAssemblyEnvV2)

MT3_CUSTOMIZED = OrderedDict(
    (('button-press-topdown-wall-v2', SawyerButtonPressTopdownWallEnvV2),
     ('door-open-v2', SawyerDoorEnvV2), ('hammer-v2', SawyerHammerEnvV2)),)

MT3_CUSTOMIZED_ARGS_KWARGS = {
    key:
    dict(args=[],
         kwargs={
             'task_id': list(_env_dict.ALL_V2_ENVIRONMENTS.keys()).index(key)
...
MT5_CUSTOMIZED = OrderedDict(
    (('button-press-topdown-wall-v2', SawyerButtonPressTopdownWallEnvV2),
     ('door-open-v2', SawyerDoorEnvV2), ('assembly-v2', SawyerNutAssemblyEnvV2),
...
MT10_CUSTOMIZED = OrderedDict(
    (('button-press-topdown-wall-v2', SawyerButtonPressTopdownWallEnvV2),
     ...
     ('assembly-v2', SawyerNutAssemblyEnvV2), ('hammer-v2', SawyerHammerEnvV2),
     ('handle-pull-v2', SawyerHandlePullEnvV2),
