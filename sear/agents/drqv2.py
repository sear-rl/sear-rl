...
from sear.models.encoder import DrQV2Encoder, PoolEncoder
...
class DrQV2Agent:
    ...
    def __init__(self, obs_shape, action_shape, device, lr, feature_dim,
                 ...
                 use_pool_encoder, pool_encoder_latent_dim):
        self.device = device
        ...
        # models
        if use_pool_encoder:
            self.encoder = PoolEncoder(
                obs_shape, repr_dim=pool_encoder_latent_dim).to(device)
        else:
